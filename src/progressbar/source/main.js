...
const node_sync = require('./../../blockchain/sync')
...
class ProgressBar {
	constructor(options, electronApp) {
		this._defaultOptions = {
			...
			title: 'Stan wallet syncing..',
			text: 'Stan wallet syncing..',
			detail: null,
		...
		this._styleSelector = {
			determinate: {
				text: '#text',
				detail: '#detail',
				bar: '#progressBar::-webkit-progressbar',
...
<html>
		...
		<style>
			*{
			...
			progress::-webkit-progress-value{
				...
				-moz-border-radius: 8px;
				border-radius: 8px;
				background: rgb(0,194,106);
				background: -moz-linear-gradient(90deg, rgba(0,194,106,1) 57%, rgba(0,228,166,1) 91%);
				background: -webkit-linear-gradient(90deg, rgba(0,194,106,1) 57%, rgba(0,228,166,1) 91%);
				background: linear-gradient(90deg, rgba(0,194,106,1) 57%, rgba(0,228,166,1) 91%);
			}
	...
	<body>
		<img src="http://go.zamnesia.com/tplimg/i6og/b/xxhxx/vsolo.png" id="sync-visual">
		<div id="text"></div>
